...
final class PlaybackStartedRequest extends Request implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($offsetInMilliseconds, $token) use ($instance): PlaybackStartedRequest {
            $instance->offsetInMilliseconds = $offsetInMilliseconds;
            $instance->token = $token;
            return $instance;
        }) extends PlaybackStartedRequestBuilder {};
    }
