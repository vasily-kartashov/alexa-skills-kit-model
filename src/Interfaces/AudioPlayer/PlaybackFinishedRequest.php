...
final class PlaybackFinishedRequest extends Request implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($offsetInMilliseconds, $token) use ($instance): PlaybackFinishedRequest {
            $instance->offsetInMilliseconds = $offsetInMilliseconds;
            $instance->token = $token;
            return $instance;
        };
        return new class($constructor) extends PlaybackFinishedRequestBuilder
        {
     ...
     * @return self
     */
    public static function ofOffsetInMilliseconds(int $offsetInMilliseconds): PlaybackFinishedRequest
    {
        $instance = new self;
        $instance->offsetInMilliseconds = $offsetInMilliseconds;
        return $instance;
