...
final class ViewportState implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($experiences, $mode, $shape, $pixelWidth, $pixelHeight, $dpi, $currentPixelWidth, $currentPixelHeight, $touch, $keyboard, $video) use ($instance): ViewportState {
