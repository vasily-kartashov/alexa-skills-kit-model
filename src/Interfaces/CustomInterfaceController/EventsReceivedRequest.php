...
final class EventsReceivedRequest extends Request implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($token, $events) use ($instance): EventsReceivedRequest {
            $instance->token = $token;
            $instance->events = $events;
            return $instance;
        }) extends EventsReceivedRequestBuilder {};
    }
     ...
     * @return self
     */
    public static function ofToken(string $token): EventsReceivedRequest
    {
        $instance = new self;
        $instance->token = $token;
        return $instance;
