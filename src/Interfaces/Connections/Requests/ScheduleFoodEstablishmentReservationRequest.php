...
final class ScheduleFoodEstablishmentReservationRequest extends BaseRequest implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($startTime, $partySize, $restaurant) use ($instance): ScheduleFoodEstablishmentReservationRequest {
            $instance->startTime = $startTime;
            $instance->partySize = $partySize;
            $instance->restaurant = $restaurant;
            return $instance;
        }) extends ScheduleFoodEstablishmentReservationRequestBuilder {};
    }
