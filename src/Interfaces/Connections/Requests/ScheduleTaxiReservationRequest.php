...
final class ScheduleTaxiReservationRequest extends BaseRequest implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($pickupTime, $partySize, $pickupLocation, $dropOffLocation) use ($instance): ScheduleTaxiReservationRequest {
            ...
            return $instance;
        }) extends ScheduleTaxiReservationRequestBuilder {};
    }
