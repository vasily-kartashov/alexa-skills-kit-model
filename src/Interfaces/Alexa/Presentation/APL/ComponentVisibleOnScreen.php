...
final class ComponentVisibleOnScreen implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($children, $entities, $id, $position, $tags, $transform, $type, $uid, $visibility) use ($instance): ComponentVisibleOnScreen {
            ...
            return $instance;
        }) extends ComponentVisibleOnScreenBuilder {};
    }
