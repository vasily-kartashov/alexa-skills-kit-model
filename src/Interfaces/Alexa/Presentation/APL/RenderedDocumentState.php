...
final class RenderedDocumentState implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($token, $version, $componentsVisibleOnScreen) use ($instance): RenderedDocumentState {
            $instance->token = $token;
            $instance->version = $version;
            $instance->componentsVisibleOnScreen = $componentsVisibleOnScreen;
            return $instance;
        };
        return new class($constructor) extends RenderedDocumentStateBuilder
        {
