...
final class AplUserEvent extends Request implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($token, $arguments, $source, $components) use ($instance): AplUserEvent {
            $instance->token = $token;
            $instance->arguments = $arguments;
            $instance->source = $source;
            $instance->components = $components;
            return $instance;
        }) extends AplUserEventBuilder {};
    }
     ...
     * @return self
     */
    public static function ofToken(string $token): AplUserEvent
    {
        $instance = new self;
        $instance->token = $token;
        return $instance;
