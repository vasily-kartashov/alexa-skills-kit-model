...
final class ComponentVisibleOnScreenMediaTag implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($positionInMilliseconds, $state, $allowAdjustSeekPositionForward, $allowAdjustSeekPositionBackwards, $allowNext, $allowPrevious, $entities, $url) use ($instance): ComponentVisibleOnScreenMediaTag {
        ...
        return new class($constructor) extends ComponentVisibleOnScreenMediaTagBuilder
        {
