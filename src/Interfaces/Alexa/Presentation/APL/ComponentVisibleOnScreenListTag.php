...
final class ComponentVisibleOnScreenListTag implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($itemCount, $lowestIndexSeen, $highestIndexSeen, $lowestOrdinalSeen, $highestOrdinalSeen) use ($instance): ComponentVisibleOnScreenListTag {
        ...
        return new class($constructor) extends ComponentVisibleOnScreenListTagBuilder
        {
