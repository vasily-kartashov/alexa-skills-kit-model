...
final class ComponentVisibleOnScreenPagerTag implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($index, $pageCount, $allowForward, $allowBackwards) use ($instance): ComponentVisibleOnScreenPagerTag {
        ...
        return new class($constructor) extends ComponentVisibleOnScreenPagerTagBuilder
        {
