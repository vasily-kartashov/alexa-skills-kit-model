...
final class AplRenderDocumentDirective extends Directive implements JsonSerializable
{
    ...
    {
        $instance = new self();
        $constructor = function ($token, $document, $datasources, $packages) use ($instance): AplRenderDocumentDirective {
        ...
        return new class($constructor) extends AplRenderDocumentDirectiveBuilder
        {
