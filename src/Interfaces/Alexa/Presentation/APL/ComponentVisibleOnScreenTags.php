...
final class ComponentVisibleOnScreenTags implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($checked, $clickable, $disabled, $focused, $list, $listItem, $media, $ordinal, $pager, $scrollable, $spoken, $viewport) use ($instance): ComponentVisibleOnScreenTags {
        ...
        return new class($constructor) extends ComponentVisibleOnScreenTagsBuilder
        {
