...
final class RenderDocumentDirective extends Directive implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($token, $targetProfile, $document, $datasources) use ($instance): RenderDocumentDirective {
            $instance->token = $token;
            $instance->targetProfile = $targetProfile;
            $instance->document = $document;
            $instance->datasources = $datasources;
            return $instance;
        }) extends RenderDocumentDirectiveBuilder {};
    }
