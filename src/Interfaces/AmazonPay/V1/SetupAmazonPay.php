...
final class SetupAmazonPay implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($consentToken, $sellerId, $countryOfEstablishment, $ledgerCurrency, $checkoutLanguage, $billingAgreementAttributes, $needAmazonShippingAddress, $sandboxMode, $sandboxCustomerEmailId) use ($instance): SetupAmazonPay {
