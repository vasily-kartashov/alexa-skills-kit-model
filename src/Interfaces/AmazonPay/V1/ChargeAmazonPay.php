...
final class ChargeAmazonPay implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($consentToken, $sellerId, $billingAgreementId, $paymentAction, $authorizeAttributes, $sellerOrderAttributes, $providerAttributes) use ($instance): ChargeAmazonPay {
            ...
            return $instance;
        }) extends ChargeAmazonPayBuilder {};
    }
