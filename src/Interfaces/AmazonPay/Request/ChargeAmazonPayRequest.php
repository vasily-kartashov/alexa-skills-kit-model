...
final class ChargeAmazonPayRequest extends BaseAmazonPayEntity implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($sellerId, $billingAgreementId, $paymentAction, $authorizeAttributes, $sellerOrderAttributes, $providerAttributes) use ($instance): ChargeAmazonPayRequest {
            ...
            return $instance;
        }) extends ChargeAmazonPayRequestBuilder {};
    }
