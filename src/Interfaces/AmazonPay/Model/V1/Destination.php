...
final class Destination implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($name, $companyName, $addressLine1, $addressLine2, $addressLine3, $city, $districtOrCounty, $stateOrRegion, $postalCode, $countryCode, $phone) use ($instance): Destination {
            $instance->name = $name;
