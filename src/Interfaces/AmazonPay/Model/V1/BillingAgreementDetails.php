...
final class BillingAgreementDetails implements JsonSerializable
{
    ...
    {
        $instance = new self;
        $constructor = function ($billingAgreementId, $creationTimestamp, $destination, $checkoutLanguage, $releaseEnvironment, $billingAgreementStatus) use ($instance): BillingAgreementDetails {
