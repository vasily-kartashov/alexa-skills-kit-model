...
final class AuthorizationDetails implements JsonSerializable
{
     ...
     */
    public function authorizationBillingAddress()
    {
    ...
    {
        $instance = new self;
        $constructor = function ($amazonAuthorizationId, $authorizationReferenceId, $sellerAuthorizationNote, $authorizationAmount, $capturedAmount, $authorizationFee, $idList, $creationTimestamp, $expirationTimestamp, $authorizationStatus, $softDecline, $captureNow, $softDescriptor, $authorizationBillingAddress) use ($instance): AuthorizationDetails {
            ...
            $instance->authorizationBillingAddress = $authorizationBillingAddress;
            return $instance;
        };
        return new class($constructor) extends AuthorizationDetailsBuilder
        {
    ...
    public static function fromValue(array $data)
    {
        ...
        $instance->authorizationBillingAddress = isset($data['authorizationBillingAddress']) ? Destination::fromValue($data['authorizationBillingAddress']) : null;
        return $instance;
    }
    ...
    public function jsonSerialize(): array
    {
        return array_filter([
            ...
            'authorizationBillingAddress' => $this->authorizationBillingAddress
        ]);
    }
}
