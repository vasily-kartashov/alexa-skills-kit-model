...
final class BillingAgreementDetails implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($billingAgreementId, $creationTimestamp, $destination, $checkoutLanguage, $releaseEnvironment, $billingAgreementStatus, $billingAddress) use ($instance): BillingAgreementDetails {
