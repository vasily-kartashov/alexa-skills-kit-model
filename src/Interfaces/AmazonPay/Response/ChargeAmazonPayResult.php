...
final class ChargeAmazonPayResult implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($amazonOrderReferenceId, $authorizationDetails) use ($instance): ChargeAmazonPayResult {
            $instance->amazonOrderReferenceId = $amazonOrderReferenceId;
            $instance->authorizationDetails = $authorizationDetails;
            return $instance;
        }) extends ChargeAmazonPayResultBuilder {};
    }
