...
final class ListItem implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($token, $image, $textContent) use ($instance): ListItem {
            $instance->token = $token;
            $instance->image = $image;
            $instance->textContent = $textContent;
            return $instance;
        }) extends ListItemBuilder {};
    }
     ...
     * @return self
     */
    public static function ofToken(string $token): ListItem
    {
        $instance = new self;
        $instance->token = $token;
        return $instance;
