...
final class ListItemsCreatedEventRequest extends Request implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($body, $eventCreationTime, $eventPublishingTime) use ($instance): ListItemsCreatedEventRequest {
            $instance->body = $body;
            $instance->eventCreationTime = $eventCreationTime;
            $instance->eventPublishingTime = $eventPublishingTime;
            return $instance;
        }) extends ListItemsCreatedEventRequestBuilder {};
    }
     ...
     * @return self
     */
    public static function ofBody(ListItemBody $body): ListItemsCreatedEventRequest
    {
        $instance = new self;
        $instance->body = $body;
        return $instance;
