...
final class ReminderResponse implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($alertToken, $createdTime, $updatedTime, $status, $version, $href) use ($instance): ReminderResponse {
            ...
            $instance->href = $href;
            return $instance;
        }) extends ReminderResponseBuilder {};
    }
     ...
     * @return self
     */
    public static function ofAlertToken(string $alertToken): ReminderResponse
    {
        $instance = new self;
        $instance->alertToken = $alertToken;
        return $instance;
