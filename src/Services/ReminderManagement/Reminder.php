...
final class Reminder implements JsonSerializable
{
    /** @var string|null */
    ...
    public static function builder(): ReminderBuilder
    {
        $instance = new self();
        $constructor = function ($alertToken, $createdTime, $updatedTime, $status, $trigger, $alertInfo, $pushNotification, $version) use ($instance): Reminder {
        ...
        return new class($constructor) extends ReminderBuilder
        {
