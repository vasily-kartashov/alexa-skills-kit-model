...
final class Reminder implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($alertToken, $createdTime, $updatedTime, $status, $trigger, $alertInfo, $pushNotification, $version) use ($instance): Reminder {
