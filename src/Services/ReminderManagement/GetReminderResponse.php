...
final class GetReminderResponse implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($alertToken, $createdTime, $updatedTime, $status, $trigger, $alertInfo, $pushNotification, $version) use ($instance): GetReminderResponse {
            ...
            return $instance;
        }) extends GetReminderResponseBuilder {};
    }
     ...
     * @return self
     */
    public static function ofAlertToken(string $alertToken): GetReminderResponse
    {
        $instance = new self;
        $instance->alertToken = $alertToken;
        return $instance;
