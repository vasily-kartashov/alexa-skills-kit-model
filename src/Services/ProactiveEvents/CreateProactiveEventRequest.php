...
final class CreateProactiveEventRequest implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($timestamp, $referenceId, $expiryTime, $event, $localizedAttributes, $relevantAudience) use ($instance): CreateProactiveEventRequest {
            ...
            return $instance;
        }) extends CreateProactiveEventRequestBuilder {};
    }
