...
final class InSkillProduct implements JsonSerializable
{
    ...
    {
        $instance = new self;
        return new class($constructor = function ($productId, $referenceName, $name, $type, $summary, $purchasable, $entitled, $entitlementReason, $activeEntitlementCount, $purchaseMode) use ($instance): InSkillProduct {
